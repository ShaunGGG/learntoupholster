...
Remove the existing upholstery, save the show fabric as a template, and inspect the frame. Drum-stool frames are usually three or four turned legs joined by a circular wooden ring at the seat — the “rim.” Check the joints between legs and rim: a wobbly drum stool nearly always has loose joints, so see [frame repair](https://www.learntoupholster.com/frame-repair-and-joint-reinforcement) before you go on.

### Stage 2 Web the rim

Three strands across, three the other way, interlaced — the same layout as a [drop-in](https://www.learntoupholster.com/drop-in-dining-seat), tacked to the top edge of the wooden rim. The stool is small enough that tension can be a touch lower than a chair seat; it carries sitter loads, not spring loads. (Full method in [webbing](https://www.learntoupholster.com/webbing).)
...
The drum-stool standard is a six-around-one hexagonal pattern: one centre button and six around it. Mark the positions before fitting the cover, make backing-patch holes through the calico, and pull each button down to about 25 mm dimple depth (full method in [buttoning & tufting](https://www.learntoupholster.com/buttoning-and-tufting)). Reckon 90 minutes as a beginner, 30 once you have it.

*Figure: The six-around-one pattern: one centre button, six in a hexagon. A ring of five looks sparse, a ring of eight crowded — the hexagon is the convention.*

### Stage 6 Trim & bottom

Gimp around the top rim where the show fabric meets the show-wood (see [trimming & finishing](https://www.learntoupholster.com/trimming-and-finishing)), a bottoming cloth across the whole underside, then sign and date it. Done.
...
An “ottoman” with a hinged storage top is a different beast: square-stool construction, but the seat lifts on hinges over a storage box. The upholstered lid is built as a separate piece — almost exactly like a [drop-in seat](https://www.learntoupholster.com/drop-in-dining-seat) — and screwed to the hinges. Quote the box and the lid separately.
