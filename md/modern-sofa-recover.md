...
This chapter walks through a typical modern three-seater sofa re-cover. The technique is largely [foam construction](https://www.learntoupholster.com/foam-construction) plus [the cover](https://www.learntoupholster.com/calico-wadding-and-top-cover) plus a staple gun. There are no traditional techniques to apply; the chapter is deliberately the shortest in Part Three.

Some traditional upholsterers refuse modern re-cover work entirely; we don’t. The work is honest, the customers are usually pleasant, and the income lets us afford to spend a fortnight on a [Chesterfield](https://www.learntoupholster.com/chesterfield-sofa). The trade-off is balance, not purity.
...
Springing: zigzag (no-sag) springs (see [modern springing](https://www.learntoupholster.com/springing-modern)), clipped to the front and back rails. Sometimes a webbing platform on the bottom for the cushions to sit on. No coil springs.
...
*Figure: Cross-section through the seat of a modern factory sofa. Chipboard or plywood frame; zigzag springs clipped to the rails; single-grade foam (sometimes two grades); Dacron wrap; top fabric stapled to the rail underside. Total thickness from rail to cover: about 100 mm.*
...
Strip. Use a staple-puller (see [the toolkit](https://www.learntoupholster.com/the-toolkit)); pull every staple out of the original cover. Most modern sofas have 200–400 staples; expect 90 minutes to remove them all. Save the original cover; flat-lay it on the bench as a fabric template for the new one.
...
Industrial walking-foot machine (see [the toolkit](https://www.learntoupholster.com/the-toolkit)); welt the visible seams (see [trimming & finishing](https://www.learntoupholster.com/trimming-and-finishing)); install zips on the back edges (see [loose covers](https://www.learntoupholster.com/loose-covers)). Total cushion-cover sewing time: about 90 minutes for all six cushions.
