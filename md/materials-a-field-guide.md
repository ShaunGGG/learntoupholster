...
Upholstery tacks are sold by length and head type. The standard sizes are 6 mm (¼″), 10 mm (⅜″), [13 mm (½″)](https://www.amazon.co.uk/s?k=13mm+upholstery+tacks&tag=842699-21)  and 16 mm (⅝″): use 13 mm for webbing, 10 mm for hessian and scrim, 6 mm for top fabric. There’s also a “fine” designation for thinner shafts where you don’t want to split a thin rail. Staples for the pneumatic gun come in widths and leg lengths; the trade standard is the [71-series staple](https://www.amazon.co.uk/s?k=71+series+upholstery+staples&tag=842699-21) , 10.6 mm wide in 6–14 mm legs — 8 mm for top fabric, 10 mm for hessian, 12 mm for webbing, bought in boxes of 5,000. Decorative nails (antique studs) are dome-headed brass or steel nails used as visible trim along arm and outside-back edges, sold by the gross; stick with plain brass for traditional work and antique brass for Chesterfields. Staple guns use the 71-series chisel-point; hand staplers use the cheaper Arrow T50 series, adequate for hessian and webbing but too coarse for show fabric.
