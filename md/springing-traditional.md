...
> Traditional hand-tied coil-spring upholstery: selecting springs by height and gauge, placing the grid, bridling to the webbing, the eight-knot lashing.
...
*Figure: Bird's-eye view of nine coil springs on the webbed seat in the standard 3 × 3 grid for a domestic armchair, set closed-end down and knot-end up.*
...
*Figure: Side cross-section of one spring after bridling and lashing: the bridle stitches at the bottom hold the spring to the webbing, while the lashing across the top sets its height and ties it to its neighbours.*
...
*Figure: The eight-knot lashing seen from above: four passes — front-to-back, side-to-side, and the two diagonals — give each spring head eight knots, two from each pass.*
