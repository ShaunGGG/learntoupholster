...
> Upholstery income arrives in lumps, and the gaps between them are what break small workshops.

Canonical: https://www.learntoupholster.com/business/the-maintenance-retainer
...
If you offer a commercial client "a monthly visit to fix your furniture", you are asking a manager to commit budget to something that is not currently a problem. That is a difficult conversation, and it is the same reason cold emails to hotels and care homes go unanswered — see [winning contract clients](https://www.learntoupholster.com/business/winning-contract-clients).
...
- Pubs, bars and restaurants with fixed banquette seating

- Hotels, and serviced or holiday accommodation

- Care and nursing homes

- Members' clubs, golf clubs, sports and social clubs

- Holiday parks and letting agents managing furnished properties

- Theatres, cinemas and function venues
...
- **Small** — one visit a quarter, an agreed number of hours, annual compliance inspection and record

- **Standard** — monthly visit, more hours, priority response for urgent items

- **Full** — more than monthly, or a fixed day each month for larger sites
...
Take the money by **Direct Debit**, not by invoice. Standing orders can be cancelled and forgotten; card details expire; invoices get paid in sixty days. GoCardless and similar services are built for exactly this, cost very little per transaction, and handle the mandate paperwork. The [invoice and quote template](https://www.learntoupholster.com/invoice-template) covers the one-off work that sits outside the retainer.
