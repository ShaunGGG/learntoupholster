...
> Three questions returning the thread, size, needle, point and stitch length for an upholstery job, with the reasoning for each.

Canonical: https://www.learntoupholster.com/sewing-selector

Three questions, and you get the thread, the size, the needle, the point and the stitch length — with the reasoning for each, so you can judge whether it fits the job in front of you.

## What are you sewing?

This decides the needle point and, less obviously, the stitch length.

## Where will the finished piece live?

Ultraviolet light is what decides nylon or polyester, and it is the choice people most often get wrong.

## What kind of seam?

A seam that is meant to be seen is specified differently from one that holds the piece together.
