...
> Modern foam upholstery, step by step: the two-foam principle (HD base plus soft top), choosing foam by density, cutting with a serrated knife, spray-bonding.
...
The [foam-density chart in the materials reference](https://www.learntoupholster.com/materials-reference-charts) is the reference for everything in this chapter. If you haven’t internalised the difference between an 18 kg/m³ and a 36 kg/m³ foam, this chapter will read wrongly. Refer back if you need to.
...
## What foam density do I need for a sofa seat?

A domestic sofa or chair seat needs a high-density base of 35–38 kg/m³ (40–45 kg/m³ for heavy use) bonded to a softer comfort top of 24–28 kg/m³, in a ratio of roughly two parts base to one part top, wrapped in polyester Dacron.

Almost every well-made foam cushion uses two grades of foam bonded together: a denser, firmer base layer that carries the structural load, and a lighter, softer top layer that provides the immediate comfort the sitter feels. The principle is exactly the same as the [first-stuffing-and-second-stuffing distinction](https://www.learntoupholster.com/stuffing-and-stitched-edges) in traditional work; only the materials are different.
...
*Figure: Cross-section of a domestic foam seat cushion. The dense base carries the load; the softer top gives the immediate comfort the sitter feels; the Dacron wrap (which folds around all four edges) softens the foam and stops the cover puckering. Spray adhesive bonds the two foam layers — roughly two parts base to one part top.*
