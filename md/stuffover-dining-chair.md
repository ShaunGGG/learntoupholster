# Stuffover Dining Chair

*Part Three · Chapter Nineteen*

> How to reupholster a traditional stuffover dining chair, step by step: stripping, webbing, the small stitched edge, calico, the top cover with the V-cut.

Canonical: https://www.learntoupholster.com/stuffover-dining-chair
...
*Figure: Cross-sections through the front rail. The drop-in (left) has a rebate cut into the rail’s top; the pad sits in it and the cover wraps only the pad. The stuffover (right) has no rebate — the stuffing and cover wrap around the whole rail and tack to the underside.*
...
Strip on the bench, working from the outside in (see [stripping the old work](https://www.learntoupholster.com/stripping-the-old-work)): cover first — one panel, tacked to the underside of the rails — then wadding, calico, the small stitched edge if there is one, the stuffing, the hessian, and finally the webbing. Keep the original cover as your cutting template.

Then inspect the frame hard. Stuffover construction is tougher on the rails than drop-in, because of repeated tacking through the same rail face; a heavily re-covered stuffover often needs a [tacking-rail repair](https://www.learntoupholster.com/frame-repair-and-joint-reinforcement) before you go again. Check the rails’ top edges for “Swiss-cheese” tack damage and quote accordingly.
...
Cover the stuffing with scrim and tack it to the rails on all four sides, pulling firmly enough to compress the stuffing into shape. The proud front is now a defined ridge of scrim-covered stuffing. Stitch it using the technique from [stuffing & stitched edges](https://www.learntoupholster.com/stuffing-and-stitched-edges) — one row of blind stitches to draw the stuffing forward, one row of top stitches to lock the rim. A stuffover edge is far smaller than a wing-back’s, so one row of each is enough: 60–90 minutes on a first attempt, 30–45 once you have it.
...
*Figure: The V-cut at a back stile, seen from above. Chalk the V from the cover’s edge to the base of the stile, cut just inside the line, and the two sides fold round the stile and tuck down behind it.*
