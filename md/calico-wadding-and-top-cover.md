...
*Figure: The three layers between the stuffing and the world. The calico under-cover is fitted first as a dress rehearsal and tacked to the rail; a thin wadding smooths it (sitting within the calico envelope, not reaching the rail); the show fabric goes over everything and tacks to the rail last.*
...
## How do you fold upholstery fabric at corners?

Fold corners with a box pleat: a triangular fold that gathers the excess cover fabric inward from both sides, leaving one clean vertical line at the corner. The show fabric itself is cut using the fitted calico as the pattern, with 50 mm of tacking allowance on every side.
...
*Figure: The box-pleat sequence at a seat corner. The cover is tacked along the front first; the side fabric is folded in to form a clean diagonal pleat; the pleat is tacked down and the side fabric is then secured along the side rail.*
...
*Figure: Cover-fit order on a typical armchair: inside panels first, outside panels last, each new panel covering the raw edges of the one before. The outside back goes on last of all. On a chair with a loose cushion, the cushion is its own panel and goes on after the outside back.*
