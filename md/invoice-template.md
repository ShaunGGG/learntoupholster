...
[Download the template — free (.xlsx)](https://www.learntoupholster.com/assets/upholstery-invoice-template.xlsx)No email required. Works in Excel, LibreOffice and Google Sheets.

*Figure: The quote page — your logo top-left, your terms at the bottom, and every total calculated for you.*
...
Quoting a job? The [cost estimator](https://www.learntoupholster.com/reupholstery-cost-calculator) gets you to a defensible number, and [Visualiser Pro](https://pro.learntoupholster.com/) shows the customer their own chair in the fabric before they sign the quote — the two ends of the same sale.
